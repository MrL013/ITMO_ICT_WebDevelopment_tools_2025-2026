# Лабораторная работа 2. Параллелизм и асинхронность в Python

В этой лабораторной работе реализованы два задания, посвящённые сравнению подходов `threading`, `multiprocessing` и `asyncio`.

## Что реализовано

- `task1` — сравнение трёх подходов на задаче вычисления суммы чисел от `1` до `10_000_000_000_000`
